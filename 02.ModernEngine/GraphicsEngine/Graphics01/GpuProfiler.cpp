...
FlatHashMap<u64, u32> name_to_color;
...
void GPUProfiler::init(Allocator* allocator_, u32 max_frames_)
{
    ...
    timestamps = (GPUTimestamp*)GAlloca(sizeof(GPUTimestamp) * max_frames * 32, allocator);
    per_frame_active = (u16*)GAlloca(sizeof(u16) * max_frames, allocator);
    ...
    name_to_color.SetDefaultValue(u32Max);
}
...
void GPUProfiler::shutdown()
{
    ...
    GFree(per_frame_active, allocator);
}
...
void GPUProfiler::update(GpuDevice& gpu)
{
    ...
    for (u32 i = 0; i < active_timestamps; ++i)
    {
        ...
        timestamp.color = Color::GetDistinctColor(color_index);
    }
