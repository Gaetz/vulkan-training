...
namespace glTF
{
    ...
    static_assert(INVALID_INT_VALUE == i32Max, "Mismatch between invalid int and i32 max");
...
i32 GltfGetAttributeAccessorIndex(glTF::MeshPrimitive::Attribute* attributes, u32 attribute_count, cstring attribute_name);