...
//  init
// =============================================================================
bool Step03Renderer::init(SDL_Window* w) {
    window = w;
    ...
    Log::Info("Step03Renderer initialized — swapchain recreation enabled.");
    return true;
}
...
void Step03Renderer::cleanup() {
    ...
    Log::Info("Step03Renderer cleaned up.");
}

// =============================================================================
//  cleanupSwapchain — only swapchain-dependent resources
//  (pipeline, sync objects and command buffers survive recreation)
// =============================================================================
void Step03Renderer::cleanupSwapchain() {
    imageViews.clear();
    swapchain.clear();
}
...
// =============================================================================
//  recreateSwapchain
//  Called when eErrorOutOfDateKHR / eSuboptimalKHR is returned, or when
//  onWindowResized() sets framebufferResized = true.
// =============================================================================
void Step03Renderer::recreateSwapchain() {
    // Wait while minimized (zero pixel size)
    int w = 0, h = 0;
    ...
    // If the swapchain image count changed, rebuild the per-image semaphores.
...
//  render
// =============================================================================
void Step03Renderer::render(IScene& /*scene*/) {
    ...
    //    On eErrorOutOfDateKHR we must recreate immediately (cannot present).
    //    NOTE: fence is NOT reset yet — if we return early the next frame
    //    will find the fence already signaled and proceed correctly.
    ...
    // 3. Reset fence only after a successful acquire (prevents fence deadlock)
    ...
    // 6. Present — handle out-of-date / suboptimal / explicit resize
...
//  recordCommandBuffer
// =============================================================================
void Step03Renderer::recordCommandBuffer(vk::raii::CommandBuffer& cmd, uint32_t imageIndex) {
...
//  initCommandBuffers
// =============================================================================
bool Step03Renderer::initCommandBuffers() {
...
// =============================================================================
//  initSyncObjects
//  imageAvailableSemaphores + inFlightFences : per frame slot
//  renderFinishedSemaphores                 : per swapchain image
// =============================================================================
bool Step03Renderer::initSyncObjects() {
...
//  initVulkan
// =============================================================================
bool Step03Renderer::initVulkan(SDL_Window* w) {
    auto instanceResult = vkb::InstanceBuilder{}
        .set_app_name("Vulkan Tutorial — Step 03")
...
//  initSwapchain
// =============================================================================
bool Step03Renderer::initSwapchain(SDL_Window* w) {
...
//  initImageViews
// =============================================================================
bool Step03Renderer::initImageViews() {
...
//  initAllocator
// =============================================================================
bool Step03Renderer::initAllocator() {
