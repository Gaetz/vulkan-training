...
#include "../../Engine/Renderer/GltfModelLoader.hpp"
#include "../../Engine/Renderer/KtxTextureLoader.hpp"
...
//  destroyVMAResources
// =============================================================================
void Step11Renderer::destroyVMAResources() {
...
//  init
// =============================================================================
bool Step11Renderer::init(SDL_Window* w) {
    window = w;
    ...
    Log::Info("Step11Renderer initialized — MSAA %ux.",
...
void Step11Renderer::cleanup() {
    ...
    Log::Info("Step11Renderer cleaned up.");
}

// =============================================================================
//  cleanupSwapchain / recreateSwapchain
// =============================================================================
void Step11Renderer::cleanupSwapchain() {
...
void Step11Renderer::recreateSwapchain() {
    int w = 0, h = 0;
...
// =============================================================================
vk::SampleCountFlagBits Step11Renderer::getMaxUsableSampleCount() {
...
//  findDepthFormat
// =============================================================================
vk::Format Step11Renderer::findDepthFormat() {
    for (vk::Format fmt : {
...
//  initMsaaResources
// =============================================================================
bool Step11Renderer::initMsaaResources() {
...
//  initDepthResources
// =============================================================================
bool Step11Renderer::initDepthResources() {
...
// =============================================================================
void Step11Renderer::onSceneReady(IScene& scene) {
    auto& s = static_cast<Step11Scene&>(scene);
    initDescriptors(s.getTexture());
}

// =============================================================================
//  loadGltfModel — public, called from Step11Scene::init()
// =============================================================================
Model Step11Renderer::loadGltfModel(const std::string& path) {
    return GltfModelLoader{device, allocator, commandPool, graphicsQueue}.load(path);
}

// =============================================================================
//  loadKtxTexture — public, called from Step11Scene::init()
// =============================================================================
Texture Step11Renderer::loadKtxTexture(const std::string& path) {
    return KtxTextureLoader{device, physDevice, allocator, commandPool, graphicsQueue}.load(path);
}

// =============================================================================
//  initDescriptors
// =============================================================================
bool Step11Renderer::initDescriptors(const Texture& texture) {
...
//  render
// =============================================================================
void Step11Renderer::render(IScene& scene) {
...
//  recordCommandBuffer
// =============================================================================
void Step11Renderer::recordCommandBuffer(vk::raii::CommandBuffer& cmd, uint32_t imageIndex,
                                          const Model& model) {
...
//  initCommandBuffers
// =============================================================================
bool Step11Renderer::initCommandBuffers() {
...
//  initSyncObjects
// =============================================================================
bool Step11Renderer::initSyncObjects() {
    for (uint32_t i = 0; i < MAX_FRAMES_IN_FLIGHT; ++i) {
...
//  initVulkan
// =============================================================================
bool Step11Renderer::initVulkan(SDL_Window* w) {
    auto instanceResult = vkb::InstanceBuilder{}
        .set_app_name("Vulkan Tutorial — Step 11")
...
//  initSwapchain
// =============================================================================
bool Step11Renderer::initSwapchain(SDL_Window* w) {
...
//  initImageViews
// =============================================================================
bool Step11Renderer::initImageViews() {
...
//  initAllocator
// =============================================================================
bool Step11Renderer::initAllocator() {
...
//  initPipeline
// =============================================================================
bool Step11Renderer::initPipeline() {
    ...
    auto shaderModule = loadShaderModule(device, "assets/shaders/11.GltfKtx2.spv");
